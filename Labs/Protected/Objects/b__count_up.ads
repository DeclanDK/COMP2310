...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_count_up" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e2285f01#;
   pragma Export (C, u00001, "count_upB");
   ...
   u00056 : constant Version_32 := 16#352452d1#;
   pragma Export (C, u00056, "system__os_interfaceB");
   u00057 : constant Version_32 := 16#b9c37c0a#;
   ...
   u00060 : constant Version_32 := 16#64ad9f76#;
   pragma Export (C, u00060, "interfaces__c__extensionsS");
   u00061 : constant Version_32 := 16#b870d14d#;
   pragma Export (C, u00061, "system__os_constantsS");
   u00062 : constant Version_32 := 16#7a0a06a1#;
   pragma Export (C, u00062, "system__task_primitives__operationsB");
   u00063 : constant Version_32 := 16#1951cab5#;
   ...
   u00088 : constant Version_32 := 16#d398a95f#;
   pragma Export (C, u00088, "ada__tagsB");
   u00089 : constant Version_32 := 16#12a0afb8#;
   pragma Export (C, u00089, "ada__tagsS");
   u00090 : constant Version_32 := 16#796f31f1#;
   pragma Export (C, u00090, "system__htableB");
   u00091 : constant Version_32 := 16#8c99dc11#;
   pragma Export (C, u00091, "system__htableS");
   u00092 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00092, "system__string_hashB");
   u00093 : constant Version_32 := 16#2ec7b76f#;
   pragma Export (C, u00093, "system__string_hashS");
   u00094 : constant Version_32 := 16#b8e72903#;
   pragma Export (C, u00094, "system__val_lluB");
   u00095 : constant Version_32 := 16#51139e9a#;
   pragma Export (C, u00095, "system__val_lluS");
   u00096 : constant Version_32 := 16#269742a9#;
   pragma Export (C, u00096, "system__val_utilB");
   u00097 : constant Version_32 := 16#a4fbd905#;
   pragma Export (C, u00097, "system__val_utilS");
   u00098 : constant Version_32 := 16#ec4d5631#;
   pragma Export (C, u00098, "system__case_utilB");
   u00099 : constant Version_32 := 16#378ed9af#;
   pragma Export (C, u00099, "system__case_utilS");
   u00100 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00100, "ada__text_ioB");
   u00101 : constant Version_32 := 16#3913d0d6#;
   ...
   u00104 : constant Version_32 := 16#92d882c5#;
   pragma Export (C, u00104, "ada__io_exceptionsS");
   u00105 : constant Version_32 := 16#73d2d764#;
   pragma Export (C, u00105, "interfaces__c_streamsB");
   u00106 : constant Version_32 := 16#b1330297#;
   pragma Export (C, u00106, "interfaces__c_streamsS");
   u00107 : constant Version_32 := 16#ec083f01#;
   pragma Export (C, u00107, "system__file_ioB");
   u00108 : constant Version_32 := 16#af2a8e9e#;
   ...
   u00111 : constant Version_32 := 16#47a91c6b#;
   pragma Export (C, u00111, "system__finalization_rootS");
   u00112 : constant Version_32 := 16#e4774a28#;
   ...
   u00117 : constant Version_32 := 16#9a896fd9#;
   pragma Export (C, u00117, "protected_element_genericB");
   u00118 : constant Version_32 := 16#fcf198de#;
   pragma Export (C, u00118, "protected_element_genericS");
   ...
   u00121 : constant Version_32 := 16#9fcf5d7f#;
   pragma Export (C, u00121, "system__tasking__protected_objectsB");
   u00122 : constant Version_32 := 16#15001baf#;
   pragma Export (C, u00122, "system__tasking__protected_objectsS");
   ...
   u00127 : constant Version_32 := 16#92cd7102#;
   pragma Export (C, u00127, "system__tasking__protected_objects__entriesB");
   u00128 : constant Version_32 := 16#7daf93e7#;
   pragma Export (C, u00128, "system__tasking__protected_objects__entriesS");
   u00129 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00129, "system__restrictionsB");
   u00130 : constant Version_32 := 16#4329b6aa#;
   pragma Export (C, u00130, "system__restrictionsS");
   u00131 : constant Version_32 := 16#0a1cacd7#;
   ...
   u00133 : constant Version_32 := 16#6213e14a#;
   pragma Export (C, u00133, "system__tasking__task_attributesB");
   u00134 : constant Version_32 := 16#e81a3c25#;
   pragma Export (C, u00134, "system__tasking__task_attributesS");
   u00135 : constant Version_32 := 16#6368532a#;
   pragma Export (C, u00135, "system__tasking__protected_objects__operationsB");
   u00136 : constant Version_32 := 16#ba36ad85#;
   pragma Export (C, u00136, "system__tasking__protected_objects__operationsS");
   u00137 : constant Version_32 := 16#891dbac0#;
   pragma Export (C, u00137, "system__tasking__entry_callsB");
   u00138 : constant Version_32 := 16#6342024e#;
   pragma Export (C, u00138, "system__tasking__entry_callsS");
   u00139 : constant Version_32 := 16#2e4883f4#;
   pragma Export (C, u00139, "system__tasking__queuingB");
   u00140 : constant Version_32 := 16#6dba2805#;
   pragma Export (C, u00140, "system__tasking__queuingS");
   u00141 : constant Version_32 := 16#0b29e756#;
   pragma Export (C, u00141, "system__tasking__utilitiesB");
   u00142 : constant Version_32 := 16#0f670827#;
   pragma Export (C, u00142, "system__tasking__utilitiesS");
   u00143 : constant Version_32 := 16#7382e823#;
   pragma Export (C, u00143, "system__tasking__rendezvousB");
   u00144 : constant Version_32 := 16#5618a4d0#;
   pragma Export (C, u00144, "system__tasking__rendezvousS");
   u00145 : constant Version_32 := 16#69297ce2#;
   pragma Export (C, u00145, "system__tasking__stagesB");
   u00146 : constant Version_32 := 16#bfc55b2f#;
   pragma Export (C, u00146, "system__tasking__stagesS");
   u00147 : constant Version_32 := 16#45a48a40#;
   pragma Export (C, u00147, "unprotected_element_genericB");
   u00148 : constant Version_32 := 16#801d782d#;
   pragma Export (C, u00148, "unprotected_element_genericS");
   ...
   --  protected_element_generic%s
   --  protected_element_generic%b
   --  unprotected_element_generic%s
   --  unprotected_element_generic%b
   --  count_up%b
